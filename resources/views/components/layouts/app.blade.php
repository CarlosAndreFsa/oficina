...
<head>
    ...
    {{-- TinyMCE  --}}
    <script src="https://cdn.tiny.cloud/1/3t98i1l3z84jk0zo00orwgengz22d0g5ovkl68ay6m32ygu5/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
...
<x-main :full-width="true">
    ...
    <x-slot:content>
        ...
        <div class="flex mt-5">
            ...
            <x-button label="DevAction" icon="o-heart" link="https://devaction.com.br" class="btn-ghost !text-pink-500" external />
        </div>
    </x-slot:content>
</x-main>
